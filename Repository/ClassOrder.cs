...
namespace Repository
{
    public class ClassOrder : ClassNotify
    {
        ...
        public ClassOrder(ClassOrder inClassOrder)
        {
			date = inClassOrder.date;
			price = inClassOrder.price;
			customerRate = inClassOrder.customerRate;
			supplierRate = inClassOrder.supplierRate;
			ownProfit = inClassOrder.ownProfit;
			volume = inClassOrder.volume;
			customer = new ClassCustomer(inClassOrder._customer);
			supplier= new ClassSupplier(inClassOrder._supplier);
        }
